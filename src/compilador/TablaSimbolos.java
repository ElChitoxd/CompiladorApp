...
public class TablaSimbolos 
{
    ...
    public String array( String dimension,String tipo ){
        
        int x = Integer.parseInt(dimension) -1;
        
        return "array( 0 .. "+Integer.toString(x)+","+tipo+")";
        
    }
    
    public String buscaTipoArray(int pos, String[] t){
        String x1 = arrTabla.get( pos ).getTipo();
        String[] x2 = x1.split(",");
        t[0] = x2[1].substring(0, x2[1].length()-1);
        return x1;
        
    }
    
    public boolean buscaTipoArray(String array, String[] t){
        //String x1 = arrTabla.get( pos ).getTipo();
        String[] x2 = array.split(",");
//        try{
        t[0] = x2[1].substring(0, x2[1].length()-1);
        if(t[0].equals("int")||t[0].equals("float")||t[0].equals("String"))
            return true;
        else
            return false;
  /*      }catch(Exception e){
    ...
    public void eliminaTipo(int pos){
        arrTabla.get(pos).setTipo("");
    }
